...
ADMINS = (
    # ('Your Names', 'your_email@example.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(BASEDIR, 'wirecloud_instance.db'),           # Or path to database file if using sqlite3.
...
SECRET_KEY = 'bc7%3--8ln)d*zpnsb6_7u0qqp5(&x%t0e8w5q0%m2u2n_csrl'
...
FIWARE_IDM_SERVER = 'http://172.17.0.5:3000'

SOCIAL_AUTH_FIWARE_KEY = '3001ff69-60b5-4e31-9937-04a38ba598ac'
SOCIAL_AUTH_FIWARE_SECRET = 'bb3e1049-521f-4bb0-bc87-27c1e6fbe75c'
